...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      <div className="w-full md:w-[60vw] px-12 pt-8 pb-12 bg-white rounded-xl shadow-md">
        <h3 className="text-lg font-medium text-black mb-6">Expense Tracker</h3>
        {children}
      </div>

      {/* Right Section: Design + Card + Info */}
